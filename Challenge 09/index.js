...
const userName = users.map((user) => user.displayName);
console.log(userName);

const SrFrontEndEngineer = users.filter((user) => user.jobtitle.includes('Sr. Front-End Engineer'));
console.log(SrFrontEndEngineer);

const employeeNumberSum = users.reduce((number, user) => number + user.employeeNumber, 0); 

console.log(employeeNumberSum)
 
const employeeNumbers = SrFrontEndEngineer.map((user) => user.employeeNumber);
